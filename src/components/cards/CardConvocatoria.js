...
export const CardConvocatoria = (props) => {
    const { periodo, description, navegacion, aspirantes, becarios, estado } =
      props;
    return (
      <>
              ...
              <Row>
                <Col md={8} className="info d-flex flex-column py-2">
                  <div className="d-flex mb-2">
                    ...
                    {estado == 1 ? (
                      <Badge pill bg="success" style={{ width: 90 }}>
                        Activa
                      </Badge>
                    ) : (
                      <Badge pill bg="danger" style={{ width: 90 }}>
                        Finlizada
                      </Badge>
                    )}
                  </div>
                  <p>{description}</p>
                  <button className="btn-detalles2" onClick={navegacion}>
                    Mas detalles
                  </button>
                </Col>
